...
Add-HostsEntry "cm.Demo-nextjs.localhost"
Add-HostsEntry "cd.Demo-nextjs.localhost"
Add-HostsEntry "id.Demo-nextjs.localhost"
Add-HostsEntry "www.Demo-nextjs.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.Demo-nextjs.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.Demo-nextjs.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.Demo-nextjs.localhost"
    ...
    Set-EnvFileVariable "JSS_EDITING_SECRET" -Value $jssEditingSecret -Path .\src\Project\Demo\nextjs\.env
}
