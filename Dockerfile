...
RUN msbuild .\src\Environment\platform\Demo.Environment.Platform.csproj /p:Configuration=$env:BUILD_CONFIGURATION /m /p:DeployOnBuild=true /p:PublishProfile=Local
