...
dotnet sitecore login --cm https://cm.Demo-nextjs.localhost/ --auth https://id.Demo-nextjs.localhost/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.Demo-nextjs.localhost/sitecore/
Start-Process https://www.Demo-nextjs.localhost/
